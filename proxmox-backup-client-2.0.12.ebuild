...
src_unpack() {
	...
	EGIT_COMMIT="48ef8390435c9ffc8c2ab5e0213feffdb21f87dd"
	...
	EGIT_COMMIT="d65b2df750cb5ae2fe7b61bf1e896c9a7a81f5bf"
	EGIT_CHECKOUT_DIR=${WORKDIR}/proxmox-openid-rs 
	git-r3_src_unpack
	# version 2.0.12-1
	EGIT_REPO_URI="https://git.proxmox.com/git/proxmox-backup.git"
	EGIT_COMMIT="bd10af6edadb35c3afa568e432790c2264b24a44"
